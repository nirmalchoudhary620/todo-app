...
add_button = sg.Button("Add", tooltip="Add todo", key="Add")  # Button to add a new todo
...
complete_button = sg.Button("Complete", tooltip="Complete todo", key="Complete")  # Button to remove selected todo
